...
// global
var todos = [];
var navState = 'All'; // 💚 요소 노드 취득 모음

var $todos = document.querySelector('ul.todos');
var $input = document.querySelector('.input-todo');
var $numOfCompleted = document.querySelector('span.completed-todos');
var $numOfActive = document.querySelector('strong.active-todos');
var $nav = document.querySelector('.nav');
var $ckAll = document.getElementById('ck-complete-all');
var $clearBtn = document.querySelector('.clear-completed > button.btn'); // 💚 이벤트 핸들러 모음
// item 개수 세기

var countNum = function countNum() {
  var cnt = 0;
  var cntTodos = 0; // count completed

  todos.reduce(function (_, todo) {
    if (todo.completed) return ++cnt;
    return cnt;
  }, 0);
  $numOfCompleted.textContent = cnt; // count active

  todos.reduce(function () {
    return ++cntTodos;
  }, 0);
...
var render = function render() {
  ...
  var _todos = todos.filter(function (todo) {
    return navState === 'All' ? true : navState === 'Active' ? !todo.completed : todo.completed;
  });
  ...
  $todos.innerHTML = html; // item 개수 세기
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            setTodos(_todos); // async 함수는 반드시 프로미스를 리턴함.
...
var addTodo = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(content) {
    var res, _todos;
...
var toggleCompleted = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(targetId) {
    var _todos$find, completed, res, _todos;

    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _todos$find = todos.find(function (_ref5) {
              var id = _ref5.id;
              return id === +targetId;
            }), completed = _todos$find.completed;
            _context3.next = 3;
            return fetch("/todos/".concat(targetId), {
              method: 'PATCH',
              headers: {
                'content-type': 'application/json'
              },
  ...
  return function toggleCompleted(_x2) {
...
var removeTodo = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(targetId) {
    var res, _todos;
  ...
  return function removeTodo(_x3) {
    return _ref6.apply(this, arguments);
  };
}(); // 탭별 item 조회하기(navState 변경하기)


var changeNavState = function changeNavState(tab, classlist) {
  if (classlist.contains('active')) return; // change navState

  navState = tab.textContent;

  _toConsumableArray($nav.children).forEach(function (li) {
...
var markAllck = /*#__PURE__*/function () {
...
document.addEventListener('DOMContentLoaded', fetchTodos); // 새로운 todo 추가하기

$input.onkeyup = function (e) {
  if (e.key !== 'Enter') return;
  addTodo(e.target.value); // 입력창 초기화
